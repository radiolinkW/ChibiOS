/*
    ...
    Driver by Radiolink , March 2022
*/

/**
 * @file        GPIOv1/hc32_gpio.h
 * @brief       HC32 GPIO units common header.
 * @note        This file requires definitions from the ST HC32 header file.
 *
 * @addtogroup HC32_GPIOV1
 * @{
 */
 ...
 * @{
 */
//#define GPIO_PIN_00                 (0x00U)  /*!< Pin 00 selected   */
//#define GPIO_PIN_01                 (0x01U)  /*!< Pin 01 selected   */
//#define GPIO_PIN_02                 (0x02U)  /*!< Pin 02 selected   */
//#define GPIO_PIN_03                 (0x03U)  /*!< Pin 03 selected   */
//#define GPIO_PIN_04                 (0x04U)  /*!< Pin 04 selected   */
//#define GPIO_PIN_05                 (0x05U)  /*!< Pin 05 selected   */
//#define GPIO_PIN_06                 (0x06U)  /*!< Pin 06 selected   */
//#define GPIO_PIN_07                 (0x07U)  /*!< Pin 07 selected   */
//#define GPIO_PIN_08                 (0x08U)  /*!< Pin 08 selected   */
//#define GPIO_PIN_09                 (0x09U)  /*!< Pin 09 selected   */
//#define GPIO_PIN_10                 (0x0AU)  /*!< Pin 10 selected   */
//#define GPIO_PIN_11                 (0x0BU)  /*!< Pin 11 selected   */
//#define GPIO_PIN_12                 (0x0CU)  /*!< Pin 12 selected   */
//#define GPIO_PIN_13                 (0x0DU)  /*!< Pin 13 selected   */
//#define GPIO_PIN_14                 (0x0EU)  /*!< Pin 14 selected   */
//#define GPIO_PIN_15                 (0x0FU)  /*!< Pin 15 selected   */
//#define GPIO_PIN_MASK               (0xFFFFU)  /*!< PIN mask for assert test */
...
typedef struct
{
    uint16_t PinState;     /*!< Set pin state to High or Low, @ref GPIO_PinState_Sel for details       */
    uint16_t PinDir;       /*!< Pin mode setting, @ref GPIO_PinDirection_Sel for details               */
    uint16_t PinOType;     /*!< Output type setting, @ref GPIO_PinOutType_Sel for details              */
    uint16_t PinDrv;       /*!< Pin drive capacity setting, @ref GPIO_PinDrv_Sel for details           */
    uint16_t Latch;        /*!< Pin latch setting, @ref GPIO_PinLatch_Sel for details                  */
    uint16_t PullUp;       /*!< Internal pull-up resistor setting, @ref GPIO_PinPU_Sel for details     */
    uint16_t Invert;       /*!< Pin input/output invert setting, @ref GPIO_PinInvert_Sel               */
    uint16_t PinIType;     /*!< Input type setting, @ref GPIO_PinInType_Sel                            */
    uint16_t ExInt;        /*!< External interrupt pin setting, @ref GPIO_PinExInt_Sel for details     */
    uint16_t PinAttr;      /*!< Digital or analog attribute setting, @ref GPIO_PinMode_Sel for details */
} hc_gpio_init_t;

#define PCRMask  (GPIO_PCR_POUT | GPIO_PCR_POUTE | GPIO_PCR_NOD  |  \
             	 GPIO_PCR_DRV  | GPIO_PCR_PUU   | GPIO_PCR_INVE |  \
				 GPIO_PCR_INTE | GPIO_PCR_LTE)

#endif /* __HC32_GPIO_H__ */
