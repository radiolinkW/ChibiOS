...
static inline uint16_t _pal_lld_readpad(uint8_t port, uint16_t pad)
{
	...
	uint16_t    GPIO_State;
	PCRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PCRA0) + \
								   ((uint32_t)(port) * 0x40UL) + pad * 4UL);
	GPIO_State = READ_REG16_BIT(*PCRx,GPIO_PCR_POUTE);
	if(GPIO_State == 1)
	{
	  PODRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PODRA) + 0x10UL * port);
	  return ((*PODRx & (1UL << pad)) != 0U) ? Pin_Set : Pin_Reset;
	}
	else
	{
	  PIDRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PIDRA) + 0x10UL * port);
	  return ((READ_REG16(*PIDRx) & (1UL << pad)) != 0U) ? Pin_Set : Pin_Reset;
	}
}
...
static inline uint16_t _pal_lld_readline(uint16_t line)
{
    ...
    __IO uint16_t *PIDRx;
      uint16_t GPIO_State;
      PCRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PCRA0) + \
                                         ((uint32_t)(PAL_PORT(line)) * 0x40UL) + PAL_PAD(line) * 4UL);
      GPIO_State = READ_REG16(*PCRx);
      if(GPIO_State == 0x0002)
      {
        PODRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PODRA) + 0x10UL * PAL_PORT(line));
...
static inline void _pal_lld_enablepadevent(uint16_t port,uint16_t pad,uint8_t mode)
{
  __IO uint16_t *PCRx;
    ...
    SET_REG32_BIT(*(uint32_t *)((uint32_t)(&M4_INTC->EIRQCR0) + 4UL * pad),(uint32_t)mode);
}
...
static inline void _pal_lld_enablelineevent(uint16_t line, uint8_t mode)
{
	...
	PCRx = (__IO uint16_t *)((uint32_t)(&M4_GPIO->PCRA0) + \
								 ((uint32_t)(PAL_PORT(line)) * 0x40UL) + PAL_PAD(line) * 4UL);
	SET_REG16_BIT(*PCRx,0x1000);
	SET_REG32_BIT(*(uint32_t *)((uint32_t)(&M4_INTC->EIRQCR0) + 4UL * PAL_PAD(line)),(uint32_t)mode);

	IRQn_Type HC32_PORTn_EIRQ_IRQn = HC32_PORT0_EIRQ_IRQn;
	en_int_src_t HC32_PORTn_EIRQ_SRC = HC32_PORT0_EIRQ_SRC;
	switch(PAL_PAD(line)){

	case 0: HC32_PORTn_EIRQ_IRQn = HC32_PORT0_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT0_EIRQ_SRC;
			break;
	case 1: HC32_PORTn_EIRQ_IRQn = HC32_PORT1_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT1_EIRQ_SRC;
			break;
	case 2: HC32_PORTn_EIRQ_IRQn = HC32_PORT2_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT2_EIRQ_SRC;
			break;
	case 3: HC32_PORTn_EIRQ_IRQn = HC32_PORT3_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT3_EIRQ_SRC;
			break;
	case 4: HC32_PORTn_EIRQ_IRQn = HC32_PORT4_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT4_EIRQ_SRC;
			break;
	case 5: HC32_PORTn_EIRQ_IRQn = HC32_PORT5_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT5_EIRQ_SRC;
			break;
	case 6: HC32_PORTn_EIRQ_IRQn = HC32_PORT6_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT6_EIRQ_SRC;
			break;
	case 7: HC32_PORTn_EIRQ_IRQn = HC32_PORT7_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT7_EIRQ_SRC;
			break;
	case 8: HC32_PORTn_EIRQ_IRQn = HC32_PORT8_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT8_EIRQ_SRC;
			break;
	case 9: HC32_PORTn_EIRQ_IRQn = HC32_PORT9_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT9_EIRQ_SRC;
			break;
	case 10: HC32_PORTn_EIRQ_IRQn = HC32_PORT10_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT10_EIRQ_SRC;
			break;
	case 11: HC32_PORTn_EIRQ_IRQn = HC32_PORT11_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT11_EIRQ_SRC;
			break;
	case 12: HC32_PORTn_EIRQ_IRQn = HC32_PORT12_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT12_EIRQ_SRC;
			break;
	case 13: HC32_PORTn_EIRQ_IRQn = HC32_PORT13_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT13_EIRQ_SRC;
			break;
	case 14: HC32_PORTn_EIRQ_IRQn = HC32_PORT14_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT14_EIRQ_SRC;
			break;
	case 15: HC32_PORTn_EIRQ_IRQn = HC32_PORT15_EIRQ_IRQn;
			HC32_PORTn_EIRQ_SRC = HC32_PORT15_EIRQ_SRC;
			break;
	default:
			break;
	}
	...
	INTC_SELx = (__IO uint32_t *)((uint32_t)(&M4_INTC->SEL0) + (4U * (uint32_t)HC32_PORTn_EIRQ_IRQn));
	if (0x1FFUL == ((*INTC_SELx) & 0x1FFUL))
	{
		WRITE_REG32(*INTC_SELx, HC32_PORTn_EIRQ_SRC);
	}

	NVIC_ClearPendingIRQ(HC32_PORTn_EIRQ_IRQn);                      /* Clear Pending */
	NVIC_SetPriority(HC32_PORTn_EIRQ_IRQn, HC32_EXIT_IRQ_PRIORITY);     /* Set priority */
	NVIC_EnableIRQ(HC32_PORTn_EIRQ_IRQn);                            /* Enable NVIC */
}
