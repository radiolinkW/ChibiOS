...
#if HC32_ICU_USE_TIM6_3  //use for USART1 2 6 RTO
...
#if HC32_ICU_USE_TIM6_4 //not used
...
#if HC32_ICU_USE_TIM6_5 //not used
...
#if HC32_ICU_USE_TIM6_7 //not used
...
#if HC32_ICU_USE_TIM6_8 //not used
...
#define HC32_USART1_TCI_NUMBER                         Int013_IRQn
#define HC32_USART1_TCI_HANDLER                        Vector74
#endif
...
#define HC32_USART2_TCI_NUMBER                         Int012_IRQn
#define HC32_USART2_TCI_HANDLER                        Vector70
...
#define HC32_USART6_TCI_NUMBER                         Int014_IRQn
#define HC32_USART6_TCI_HANDLER                        Vector78
...
#define HC32_IRQ_PORT0_PRIORITY            10
#endif
...
#define HC32_IRQ_PORT1_PRIORITY            10
#endif
...
#define HC32_IRQ_PORT2_PRIORITY            10
#endif
...
#define HC32_IRQ_PORT3_PRIORITY            10
#endif
...
#define HC32_IRQ_PORT4_PRIORITY            10
#endif
...
#define HC32_IRQ_PORT5_PRIORITY          10
#endif
...
#define HC32_IRQ_PORT6_PRIORITY        10
#endif
...
#define HC32_IRQ_PORT7_PRIORITY           10
#endif
...
#define HC32_IRQ_PORT8_PRIORITY           10
#endif
...
#define HC32_IRQ_PORT9_PRIORITY           10
#endif
...
#define HC32_IRQ_PORT10_PRIORITY           10
#endif
...
#define HC32_IRQ_PORT11_PRIORITY           10
#endif
...
#define HC32_IRQ_PORT12_PRIORITY        10
#endif
...
#define HC32_IRQ_PORT13_PRIORITY        10
#endif
...
#define HC32_IRQ_PORT14_PRIORITY        10
#endif
...
#define HC32_IRQ_PORT15_PRIORITY        10
#endif
/** @} */
/*===========================================================================*/
